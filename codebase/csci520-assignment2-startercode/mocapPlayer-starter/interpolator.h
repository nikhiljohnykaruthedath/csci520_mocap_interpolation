...
typedef double matrix3x3Double[3][3];
...
public: 
  ...
  void MatrixMultiplication(matrix3x3Double inputA, matrix3x3Double inputB, matrix3x3Double outputC);

  // Convert degrees to radians
  double ConvertDegreeToRadian(double degree) { return (M_PI / 180) * degree; }
